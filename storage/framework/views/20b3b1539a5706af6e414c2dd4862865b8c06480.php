...
<div class="container" style="width: 600px;margin-top: 40px;margin-right: 5%; margin-bottom: 20px;">
    <div class="input-group">
      ...
      <a href="<?php echo e(route('clients.create')); ?>" class="btn btn-info">اضافة عميل</a>
                ...
                <div class="col">
                    <div class="card shadow-sm">
                       ...
                       <label for="name" class="form-label text-primary">العنوان</label>
                        <p class="card-text"> <?php echo e($client["adress"]); ?>  </p>
                        
                       <label for="name" class="form-label text-primary">الموبايل</label>
                        <p class="card-text"> <?php echo e($client["phone_number"]); ?>  </p>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <small class="text-muted"><?php echo e($client->created_at); ?></small>
                        </div>
                        <div>
                        <a class="btn btn-warning" href="<?php echo e(route('clients.show' , [$client->id])); ?>">عرض</a>
                            <a class="navbar-brand" href="#">
                                <img src="<?php echo e(asset('profilepic'). '/'. $client->user->profile_pic); ?>" alt="Logo" style="width:40px;" class="rounded-pill"> <small class="text-muted"><?php echo e($client->user->name); ?></small>
                              </a>
                            </div>
                    </div>
                    </div>
...
<?php /**PATH E:\Final Project\final-laravel-main\resources\views/clients/index.blade.php ENDPATH**/ ?>
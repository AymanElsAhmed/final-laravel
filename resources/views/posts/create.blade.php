        ...
        <div class="container">
            <form action="{{ route('posts.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="from" class="form-control" id="exampleInputEmail1"
                        aria-describedby="emailHelp"value="{{ old('from') }}">
                    @error('from')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="to" class="form-control" id="exampleInputEmail1"
                        aria-describedby="emailHelp" value="{{ old('to') }}">
                    @error('to')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="deliver_price" class="form-control" id="exampleInputEmail1"
                        aria-describedby="emailHelp" value="{{ old('deliver_price') }}" min="0">
                    @error('deliver_price')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <a href="{{ route('clients.create') }}" class="btn btn-primary">{{ __('New Client') }}</a>

...
<form class="row g-3"  method="POST" action="{{ route('clients.store') }}" enctype="multipart/form-data" >
  ...
  <div class="col-12">
      ...
      <input type="text" class="form-control" id="name" name="name" placeholder="برجاء ادخال الاسم"  value="{{ old('name') }}">
      @error('name')
    ...
    <div class="col-12">
      ...
      <input type="text" class="form-control" id="adress" name="adress" placeholder="برجاء ادخال العنوان" value="{{ old('adress') }}">
      @error('adress')
          <div class="alert alert-danger">{{ $message }}</div>
      @enderror
    </div>
    <div class="col-12">
      ...
      <input type="number" class="form-control" id="phone_number"  name="phone_number" placeholder="برجاء ادخال رقم الموبايل"  min="0"  dir="ltr" value="{{ old('adress') }}">
      @error('phone_number')
          <div class="alert alert-danger">{{ $message }}</div>
      @enderror
    </div>
